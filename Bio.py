...
💘
    ...
    strings = {
        ...
        "not_reply": "<emoji document_id=5404879225737978176>💔</emoji> Реплая нет.",
        
        "not_args": "<emoji document_id=5404879225737978176>💔</emoji> Аргументов нет.",
        
        "nolink": "<emoji document_id=5404879225737978176>💔</emoji> Нет ссылки.",

        "hueta": "Ничего не могу понять..<emoji document_id=5404879225737978176>💔</emoji>",
        
        "r.save":   
            "<emoji document_id=5217791902023162643>1️⃣</emoji> Жертва <b><code>{}</code></b> в зарлисте.\n"
            "<b><emoji document_id=5278372097905664675>🧬</emoji> +{}{}</b> био-ресурсов",
        "auto.save":   
            "<emoji document_id=5217791902023162643>1️⃣</emoji> Жертва <b><code>{}</code></b> в зарлисте.\n"
            "<b><emoji document_id=5278372097905664675>🧬</emoji> {}+{}</b> био-ресурсов.",        
        "search":
            "<emoji document_id=5217791902023162643>1️⃣</emoji> Жертва <code>{}</code> приносит:\n"
            "<b><emoji document_id=5278372097905664675>🧬</emoji> +{} био-ресурсов.</b>\n"
            "<emoji document_id=5766931615737449648>📆</emoji> Дата: <i>{}</i>",
        
        "nf": "<emoji document_id=5353041341297204898>⛔️</emoji> Не найдено! Скорее всего не бил, давай бей!",
        
        "no_user": "<emoji document_id=5353041341297204898>⛔️</emoji> user {} don't exist.",

        "nous": "<emoji document_id=5353041341297204898>⛔️</emoji> Жертва или пользователь не существует.",

        "anf": "<emoji document_id=5353041341297204898>⛔️</emoji> некого искать..",

        "aicmd":
            "<b><emoji document_id=5456549108237999662>🥷</emoji></b> <a href='tg://openmessage?user_id={}'>{}</a>\n"
            "<b><emoji document_id=5818885490065017876>🆔</emoji>:</b> <code>@{}</code>",
        "myid": "<b>My <emoji document_id=5818885490065017876>🆔</emoji>:</b> <code>@{}</code>",
        ...
        "user_rm": "<emoji document_id=5404879225737978176>💔</emoji> Помощник <b><code>{}</code></b> удалён, туда иго<emoji document_id=5361597229683449359>😡</emoji>.",
        
        "user_add": "<emoji document_id=5818651538901437748>➕</emoji> Помощник <b><code>{}</code></b> добавлен!",
        
        "wrong_nick": "<b><emoji document_id=5230982773086365287>📝</emoji> Введите ник.</b>",
        
        "nick_add": "<emoji document_id=5269541829828681541>🤫</emoji> Ник доверки <b>{}</b> установлен!",
        
        "dov_start": "<b><emoji document_id=5312005278131035686>🚀</emoji> Успешно запущено!</b>",
        
        "dov_stop": "<b><emoji document_id=5375464961822695044>🎬</emoji> Успешно остановлено.</b>",
        
        "dov.wrong_args": 
            "<b><emoji document_id=5404879225737978176>💔</emoji> Неизвестный аргумент.</b>\n"
            "<i>📝 Введите <code>.дов</code> для просмотра команд.</i>",   
        
        "wrong_id": "<emoji document_id=5404879225737978176>💔</emoji> Правильно введи 🆔 без <emoji document_id=5818885490065017876>🆔</emoji>.",
        
        "ex": "💕 Исключение: <code>{}</code>",
        
        "wrong_ot-do": '<emoji document_id=5404879225737978176>💔</emoji> Используй <b>правильно</b> функцию "от-до".',
        
        "no_sargs": "<emoji document_id=5404879225737978176>💔</emoji> Не найдено совпадение в на����але строк с аргументами.",
        
        "no_link": "<emoji document_id=5404879225737978176>💔</emoji> Ссылка не найдена.",
        
        "too_much_args": "<emoji document_id=5404879225737978176>💔</emoji> Кол-во аргументов <b>больше</b> одного, либо начинается <b>не</b> со знака <code>@</code>",
        
        "no_zar_reply": "<emoji document_id=5404879225737978176>💔</emoji> Нет реплая на сообщение ириса о заражении.",
        
        "empty_zar": "<emoji document_id=5404879225737978176>💔</emoji> Список заражений пуст.",
        
        "wrong_zar_reply": '<emoji document_id=5404879225737978176>💔</emoji> Реплай <b>не</b> на сообщение ириса о заражении "<b>...подверг заражению...</b>"',
        
        "wrong_cmd": "<emoji document_id=5404879225737978176>💔</emoji> Команда введена некорректно.",
        
        "empty_ex": "<emoji document_id=5404879225737978176>💔</emoji> Cписок исключений пуст.",
        
        "tids": "<b><emoji document_id=5240008659743808004>🧠</emoji> Id'ы успешно извлечены.</b>",
        
        "tzar": "<emoji document_id=5213468029597261187>✔️</emoji> Заражения завершены.",
        ...
        "exadd": "<emoji document_id=5312455442243264824>🔦</emoji> Пользователь <code>{}</code> в исключениях.",
...
(без них бьет по ответу с 10 патов)
        ...
        if not args:
            ...
            hui = f'<code>Ирис заразить 10 @{vlad}<code>\nспасибки <emoji document_id=5235508508975177195>☺️</emoji><emoji document_id=5267071038222509469>🙏</emoji>'
                    ...
                    if 'href="' in x:
                        ...
                        if link.startswith('tg'):
                            ...
                            if users in exlist:
                                ...
                                await message.client.send_message(message.peer_id, 
                                    f'<code>Ирис заразить 5 {users}</code>\n<code></code>',
                                    reply_to=reply)
                ...
                try:
                    ...
                    if link.startswith('tg'):
                        ...
                        if users in exlist:
                            ...
                            await message.reply(f'Ирис заразить {users}')
                    elif link.startswith('https://t.me'):
                        a = '@' + str(link.split("/")[3])
                        if a in exlist:
                            await message.reply(
                            ...
                            await message.reply(f'Ирис заразить {a}')
                    else:
                        await message.reply(
                            self.strings("hueta")
                        )
                    ...
                    if blayt in exlist:
                        ...
                        await message.reply(f"Ирис заразить {blayt}")
                await asyncio.sleep(3.3)
...
Введи команду для просмотра аргументов.
        ...
        if len(args) == 1 and not reply and args[0] != 'пуск': # 
            return await utils.answer(message, '<emoji document_id=5463085820829245815>🤬</emoji> Не могу понять, что за херня?<emoji document_id=6053056792194189095>🤬</emoji>..')
...
#### кач    алки
        ...
        if self.config["Доступ к хиллингу"] == True:    
            if re.search(r"вак[цинау]{,3}|леч[ись]{,2}|хи[лльсяйинг]{,2}|лек[арство]{,2}", text, flags=re.ASCII):
                await message.reply('Ирис купить вакцину')
            ...
            if re.fullmatch(r"лаб[ау]{,2}", toxt, flags=re.ASCII): # регулярка
                ...
                for i in lab_lines: # цикл for по всем строкам в тексте лабы
                    if "🧪 Готовых патогенов:" in i:
                        ...
                        sms += f"<emoji document_id=5404418573315612177>🐉</emoji> готовые болячки:{s}\n"
                    if "⏱ Новый патоген:" in i:
                        s = i.replace("⏱ Новый патоген:", "")
                        sms += f"<emoji document_id=5345899012547420343>🐾</emoji> новая болячка:{s}\n"
                    if "🦠 Заразность:" in i:
                        s = i.replace("🦠 Заразность:", "")
                        sms += f"<emoji document_id=5454030784228761136>🐲</emoji> заразность болячки:{s}\n"
                    if "🧬 Био-ресурс:" in i:
                        s = i.replace("🧬 Био-ресурс:", "")
                        sms += f"<emoji document_id=5368544635637475254>☘️</emoji> мурк-ресов:{s}\n"
                        if "☣️ Био-опыт:" in i:
                        s = i.replace("☣️ Био-опыт:", "")
                        sms += f"<emoji document_id=5449372007432985754>🌴</emoji> мурк-опыт:{s}\n"
                    if "❗️ Руководитель в состоянии горячки, вызванной болезнью" in i:
                        ...
                        sms += f"<emoji document_id=5449850741667668411>🌿</emoji> болячка от {s}\n"
                    if "❗️ Руководитель в состоянии горячки ещё" in i:
                        s = i.replace("❗️ Руководитель в состоянии горячки ещё ", "")
                        sms += f"<emoji document_id=5449850741667668411>🌿</emoji> болячка на {s}\n"                        
                await message.reply(sms) # ответ

#не тырьте у донатика модуль
#######################################################
        if self.config["Доступ к зарлисту"] == True:
            ...
            if re.search(r"(?P<zarlist>з\s)(?P<link>@[0-9a-z_]+|tg://openmessage\?user_id=[0-9]+)",
                text, flags=re.ASCII):
                if not text.startswith(f"{nik} з") and not text.startswith(f"{nik}чек"):
                    return
            ...
            if re.search(r"з", text, flags=re.ASCII):
                if text != f"{nik} чек" and text != f"{nik}чек":
                    return
                zhertva = '@' + str(reply.sender_id)
